...
public class TelaCadastroProduto {
	...
	public void exibirMensagem(String mensagem, boolean erro) {
		...
		this.labelMensagens.setText(
				String.format("<html><div style='color: %s; font-size:12px'> %s </div></html>", cor, mensagem));
		janela.pack();
	}
	...
	private void instalarButtonSalvar() {
		buttonSalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				/**
				 * TODO 04 1. Elimine focos de acoplamento view para model presentes neste
				 * tratador de listener, nas linhas que se seguem.
				 * 
				 */
